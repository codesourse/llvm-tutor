...
#
opt -load  libOpcodeCounter.dylib -help | grep OpcodeCounter
#
#
clang -emit-llvm -c $LLVM_TUTOR_DIR/inputs/input_for_cc.c -o input_for_cc.bc

opt -load-pass-plugin ./lib/libOpcodeCounter.dylib --passes="print<opcode-counter>" -disable-output input_for_cc.bc
#
cd ..
