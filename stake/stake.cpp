...
struct FunctionCallTimePass : public FunctionPass {
    ...
    bool runOnFunction(Function &F) override {
        ...
        if (annotation.length() > 0 &&
            StringRef(annotation).contains("__AppleTraceIgnore")) {
        ...
        if (funcName.startswith("__copy")) {
            return false;
        }
        
        if (funcName.startswith("__destroy")) {
            return false;
        }
...
StringRef FunctionCallTimePass::InsertFuncNamePrefix = "__AppleTrace";
StringRef FunctionCallTimePass::BeginFuncName        = "__AppleTrace_BeginSection";
StringRef FunctionCallTimePass::EndFuncName          = "__AppleTrace_EndSection";
// 注册给 opt
